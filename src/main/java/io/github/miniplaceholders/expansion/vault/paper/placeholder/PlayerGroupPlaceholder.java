...
public final class PlayerGroupPlaceholder extends VaultPlaceholder {
    public PlayerGroupPlaceholder(VaultHook hook) {
        super(hook);
    }
    ...
    public Tag tag(
        ...
        final String group = vaultHook().primaryGroup(player);
