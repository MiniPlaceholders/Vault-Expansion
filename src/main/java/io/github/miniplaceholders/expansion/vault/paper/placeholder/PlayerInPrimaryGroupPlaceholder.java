...
public final class PlayerInPrimaryGroupPlaceholder extends VaultPlaceholder {
    public PlayerInPrimaryGroupPlaceholder(VaultHook hook) {
        super(hook);
    }
    ...
    public Tag tag(
        ...
        final boolean inGroup = vaultHook().inPrimaryGroup(player, group);
